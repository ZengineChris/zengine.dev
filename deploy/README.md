...
A [timoni.sh](http://timoni.sh) module for deploying deploy to Kubernetes clusters.
...
```shell
timoni -n default apply deploy oci://<container-registry-url>
```
...
```shell
timoni -n default delete deploy
```
